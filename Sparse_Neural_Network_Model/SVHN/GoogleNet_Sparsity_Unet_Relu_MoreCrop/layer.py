        ...
        if self.training:
            if epoch % 2 == 0:
                ...
                if self.use_bias:
                    ...
                    layer40 = F.relu(self.bn0(nn.functional.conv2d(layer31, self.gate_weights0, stride=1, padding=1, bias=None)))  # [128, 64, 2]
                    layer42 = F.relu(self.crop_bn0(nn.functional.conv2d(layer40, self.crop_gate_weights0, stride=1, bias=None)))  # [128, 64, 1]
                    ...
                    layer51 = torch.cat((layer32, layer50), dim=1)  # [128, 128, 1]
                    ...
                    layer61 = torch.cat((layer22, layer60), dim=1)  # [64, 256, 1]
                    ...
                    layer71 = torch.cat((layer12, layer70), dim=1)  # [32, 512, 1]
                    ...
                    layer81 = torch.cat((layer02, layer80), dim=1)  # [16, 1024, 1]
                    layer82 = F.relu(self.rc_bn3(nn.functional.conv2d(layer81, self.rc_gate_weights3, stride=1, bias=None)))  # [8, 1024, 1]
                    layer_out = F.relu(self.bn1(nn.functional.conv2d(layer82, self.gate_weights1, stride=1, bias=None)))  # [1, 1024, 1]
